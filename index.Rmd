...
subtitle: "Atelier R sur la réalisation d'un modèle de régression linéaire multiple de l'analyse des corrélations au diagnostics du modèle."
date: "`r paste('Modifié le',format(Sys.time(), '%d %B %Y'))`"
author: 
 - name: Grégoire Le Campion
   affiliation: UMR 5319 Passages
image: "figures/fosse.jpg"   
