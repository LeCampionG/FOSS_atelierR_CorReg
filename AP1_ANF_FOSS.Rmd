...
Par exemple, dans notre cas si nous souhaitons étudier en plus l'interaction entre la densité et le niveau de vie médian nous rajoutons à notre modèle `dens_pop*med_niveau_vis`. Ce qui nous donnerait : `reg<- lm(formula = prix_med ~ perc_log_vac + perc_maison + perc_tiny_log + dens_pop + med_niveau_vis +
part_log_suroccup + part_agri_nb_emploi + part_cadre_profintellec_nbemploi + dens_pop*med_niveau_vis, data = data_immo)`
<hr>
